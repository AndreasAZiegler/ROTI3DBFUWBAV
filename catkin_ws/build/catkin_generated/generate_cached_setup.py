...
try:
    ...
    for workspace in "/data/SP1/catkin_ws/devel;/opt/ros/jade".split(';'):
...
code = generate_environment_script('/data/SP1/catkin_ws/devel/env.sh')

output_filename = '/data/SP1/catkin_ws/build/catkin_generated/setup_cached.sh'
