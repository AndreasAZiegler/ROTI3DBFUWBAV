...
"""autogenerated by genpy from uwb/UWBRange.msg. Do not edit."""
import sys
...
class UWBRange(genpy.Message):
  _md5sum = "59f7e9a9fe44ac74dcea199a0dda5d66"
  _type = "uwb/UWBRange"
...
"""
  __slots__ = ['header','address','remote_address','stamp_us','round_trip_time','range']
  _slot_types = ['std_msgs/Header','uint8','uint8','uint32','float32','float32']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,address,remote_address,stamp_us,round_trip_time,range
