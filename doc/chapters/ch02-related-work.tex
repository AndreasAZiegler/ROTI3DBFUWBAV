...
The Extended Kalman Filter (EKF) \todo{(Which paper to cite? NASA?)} in this semester project is used to fuse the coordination information of the tracked object from the UWB system and from the vision based object tracker. The EKF model and the update steps are described in detail in \autoref{ch:fusing}.