...
\begin{align}
	...
	& = \textbf{I}_6
\end{align}
and with the initial values $\hat{\vec x}(0) = x_0$ and $\textbf{P}_m(0) = \textbf{0}$.
...
\begin{align}
	\textbf{H}(k) &= \begin{bmatrix}
		\frac{\partial}{\partial \vec x} \big( \textbf{H}_1 \vec x(k) + \vec \omega_1(k) \big)\\
		\frac{\partial}{\partial \vec x} \big( \textbf{H}_2(\vec x(k)) + \vec \omega_2(k) \big)
	\end{bmatrix}\\
	&= \begin{bmatrix}
		\textbf{I}_6\\
		\frac{1}{x_3} & 0 & -\frac{x_1}{x^2_3} & 0 & 0 & 0\\
		0 & \frac{1}{x_3} & -\frac{x_1}{x^2_3} & 0 & 0 & 0
	\end{bmatrix}\\
	\textbf{M}(k) &= \begin{bmatrix}
		\frac{\partial}{\partial \vec \omega} \big( \textbf{H}_1 \vec x(k) + \vec \omega_1(k) \big)\\
		\frac{\partial}{\partial \vec \omega} \big( \textbf{H}_2(\vec x(k)) + \vec \omega_2(k) \big)
	\end{bmatrix}\\
	&= \textbf{I}_8
\end{align}
