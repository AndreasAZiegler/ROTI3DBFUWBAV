...
\begin{table}[ht!]
	\begin{center}
		\begin{tabular}{l|l|l}
			...
			\hline
			vision\_tracker & vision\_tracker\_node & \begin{tabular}[x]{@{}l@{}}The \ac{KCF} tracker publishes the 2D pixel\\coordinates as \ac{ROS} message as well as\\boolean \ac{ROS} message which indicate,\\if the object is lost or not.\end{tabular}\\
			\hline
