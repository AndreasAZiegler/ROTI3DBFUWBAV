...
\begin{document}
	...
	\draw[thick,blue,->] (0,0,0) -- (-1,0,0) node[anchor=south east]{$x$};
	\draw[thick,green,->] (0,0,0) -- (0,1,0) node[anchor=north west]{$y$};
	\draw[thick,red,->] (0,0,0) -- (0,0,1) node[anchor=south]{$z$};
	
	%draw a vector from origin to point (P) 
	\draw[-stealth,color=black] (O) -- (P) node[anchor=north, pos=0.8]{$\vec t$};
	...
	\draw[thick,tdplot_rotated_coords,red,->] (0,0,0) -- (.5,0,0) node[anchor=north west]{$z'$};
	\draw[thick,tdplot_rotated_coords,green,->] (0,0,0) -- (0,.5,0) node[anchor=west]{$y'$};
	\draw[thick,tdplot_rotated_coords,blue,->] (0,0,0) -- (0,0,.5) node[anchor=south]{$x'$};
