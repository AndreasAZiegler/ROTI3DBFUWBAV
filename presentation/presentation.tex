...
\begin{frame}
	\frametitle{Results}
	 The $\textit{rmse}$ and the $\textit{rmse}_{xy}$ of the EKF were significantly lower ($> 50\%$) compared with the $\textit{rmse}$ and the $\textit{rmse}_{xy}$ of the UWB system (For the cases, where the visual tracker found the object).\\
	%\tiny
	%\begin{table}
%		\begin{center}
